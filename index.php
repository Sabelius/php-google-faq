...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 d-flex align-items-center">
            <img src="https://www.progettoitalianews.net/news/wp-content/uploads/2019/08/google2.0.0.jpg" alt="logo">
...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <h2 class="pt-5"><?php echo $section["Question"]?></h2>
            <p class="pt-2"><?php echo $section["Answer"]?></p>
